		...
		<?php
			if (isset($_SESSION['userUid'])) {
				...
				if (!isset($_COOKIE['userSchedule'])) {
					...
					for ($i=0;$i<36;$i++) {
						$add = array($data[$key+$i][6], $data[$key+$i][10], $data[$key+$i][16], $data[$key+$i][12]);
						$schedule[$i] = $add;
					}
					setcookie('userSchedule', json_encode($schedule), time() + (10*365*24*60*60));
					echo 'cookie created, please refresh page to view schedule';
				}
				$schedule = json_decode($_COOKIE['userSchedule']);
				echo ('
					...
					echo ('<div id="myModal1" class="modal">
						<div class="modal-content2">
							...
							<div class="modal-body2">
								<ul>');
									if ($data[$key + ($modals)][6] == "Free") {
										echo('<li>You are Free!</li>');
									}
									else {
										echo('
									<li>You have '.$data[$key + ($modals)][6].' with '.$data[$key + ($modals)][16].' in '.$data[$key + ($modals)][10].'</li>');
									}
					...
					<div class="table-wrap">
						<table class="schedule-table" style="width:100%">
							...
							<tr>
								...
								<td onclick="onClickTd(this.id)" id="td_23" class="hvr-fade"><span style="float: left;">8:25</span><br>'.$schedule[22][0].'<br>'.$schedule[22][1].'<br>'.$schedule[22][2].'<br><span style="float: left;">9:15</span></td>
								<td onclick="onClickTd(this.id)" id="td_30" class="hvr-fade"><span style="float: left;">8:25</span><br>'.$schedule[29][0].'<br>'.$schedule[29][1].'<br>'.$schedule[29][2].'<br><span style="float: left;">9:15</span></td>
							</tr>
							...
							<tr>
								...
								<td onclick="onClickTd(this.id)" id="td_17" class="hvr-fade"><span style="float: left;">9:00</span><br>'.$schedule[16][0].'<br>'.$schedule[16][1].'<br>'.$schedule[16][2].'<br><span style="float: left;">9:50</span></td>
								<td onclick="onClickTd(this.id)" id="td_24" class="hvr-fade"><span style="float: left;">9:20</span><br>'.$schedule[23][0].'<br>'.$schedule[23][1].'<br>'.$schedule[23][2].'<br><span style="float: left;">10:10</span></td>
								<td onclick="onClickTd(this.id)" id="td_31" class="hvr-fade"><span style="float: left;">9:20</span><br>'.$schedule[30][0].'<br>'.$schedule[30][1].'<br>'.$schedule[30][2].'<br><span style="float: left;">10:10</span></td>
							</tr>
							...
							<tr>
								...
								<td onclick="onClickTd(this.id)" id="td_18" class="hvr-fade"><span style="float:left;">9:55</span><br>'.$schedule[17][0].'<br>'.$schedule[17][1].'<br>'.$schedule[17][2].'<br><span style="float: left;">10:45</span></td>
								<td onclick="onClickTd(this.id)" id="td_25" class="hvr-fade"><span style="float:left;">10:15</span><br>'.$schedule[24][0].'<br>'.$schedule[24][1].'<br>'.$schedule[24][2].'<br><span style="float: left;">11:00</span></td>
								<td onclick="onClickTd(this.id)" id="td_32" class="hvr-fade"><span style="float:left;">10:15</span><br>'.$schedule[31][0].'<br>'.$schedule[31][1].'<br>'.$schedule[31][2].'<br><span style="float: left;">11:00</span></td>
							</tr>
							...
							<tr>
								...
								<td onclick="onClickTd(this.id)" id="td_19" class="hvr-fade"><span style="float: left;">10:45</span><br>'.$schedule[18][0].'<br>'.$schedule[18][1].'<br>'.$schedule[18][2].'<br><span style="float: left;">11:15</span></td>
								<td onclick="onClickTd(this.id)" id="td_26" class="hvr-fade"><span style="float: left;">11:05</span><br>'.$schedule[25][0].'<br>'.$schedule[25][1].'<br>'.$schedule[25][2].'<br><span style="float: left;">11:55</span></td>
								<td onclick="onClickTd(this.id)" id="td_33" class="hvr-fade"><span style="float: left;">11:05</span><br>'.$schedule[32][0].'<br>'.$schedule[32][1].'<br>'.$schedule[32][2].'<br><span style="float: left;">11:55</span></td>
							</tr>
							...
							<tr>
								...
								<td onclick="onClickTd(this.id)" id="td_20" class="hvr-fade"><span style="float: left;">11:20</span><br>'.$schedule[19][0].'<br>'.$schedule[19][1].'<br>'.$schedule[19][2].'<br><span style="float: left;">12:05</span></td>
								<td onclick="onClickTd(this.id)" id="td_27" class="hvr-fade"><span style="float: left;">12:00</span><br>'.$schedule[26][0].'<br>'.$schedule[26][1].'<br>'.$schedule[26][2].'<br><span style="float: left;">12:50</span></td>
								<td onclick="onClickTd(this.id)" id="td_34" class="hvr-fade"><span style="float: left;">12:00</span><br>'.$schedule[33][0].'<br>'.$schedule[33][1].'<br>'.$schedule[33][2].'<br><span style="float: left;">12:50</span></td>
							</tr>
							...
							<tr>
								...
								<td onclick="onClickTd(this.id)" id="td_21" class="hvr-fade"><span style="float: left;">12:10</span><br>'.$schedule[20][0].'<br>'.$schedule[20][1].'<br>'.$schedule[20][2].'<br><span style="float: left;">12:55</span></td>
								<td onclick="onClickTd(this.id)" id="td_28" class="hvr-fade"><span style="float: left;">12:55</span><br>'.$schedule[27][0].'<br>'.$schedule[27][1].'<br>'.$schedule[27][2].'<br><span style="float: left;">1:45</span></td>
								<td onclick="onClickTd(this.id)" id="td_35" class="hvr-fade"><span style="float: left;">12:55</span><br>'.$schedule[34][0].'<br>'.$schedule[34][1].'<br>'.$schedule[34][2].'<br><span style="float: left;">1:45</span></td>
							</tr>
							...
							<tr>
								...
								<td onclick="onClickTd(this.id)" id="td_22" class="hvr-fade"><span style="float: left;">1:00</span><br>'.$schedule[21][0].'<br>'.$schedule[21][1].'<br>'.$schedule[21][2].'<br><span style="float: left;">1:45</span></td>
								<td onclick="onClickTd(this.id)" id="td_29" class="hvr-fade"><span style="float: left;">1:50</span><br>'.$schedule[28][0].'<br>'.$schedule[28][1].'<br>'.$schedule[28][2].'<br><span style="float: left;">2:40</span></td>
								<td onclick="onClickTd(this.id)" id="td_36" class="hvr-fade"><span style="float: left;">1:50</span><br>'.$schedule[35][0].'<br>'.$schedule[35][1].'<br>'.$schedule[35][2].'<br><span style="float: left;">2:35</span></td>
							</tr>
...
function onClickTd(click_id) {
  ...
  var schedule = JSON.parse(Cookies.get('userSchedule').replace("+"," "));
  var info = "You have: " + schedule[td_id-1][0] + " with " + schedule[td_id-1][2] + " in " + schedule[td_id-1][1];
  $("#modal-head").text(info);
}
